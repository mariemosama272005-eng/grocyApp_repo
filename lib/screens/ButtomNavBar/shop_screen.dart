...
class ShopScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      ...
      padding: const EdgeInsets.fromLTRB(24.71, 0, 24.71, 100),
      child: Column(
        children: [
          Center(
            child: Image.asset(
          ...
          ShoptextWedgit(
              shopTitle: ShoptextModel(title: "Exclusive Offer")),
          const SizedBox(height: 20),
          SizedBox(
            height: 280,
          ...
          const SizedBox(height: 30),
          ShoptextWedgit(
              shopTitle: ShoptextModel(title: "Best salling")),
          const SizedBox(height: 20),
          SizedBox(
            height: 280,
            child: ListView.separated(
          ...
          const SizedBox(height: 30),
          ShoptextWedgit(
              shopTitle: ShoptextModel(title: "Grocieries")),
          const SizedBox(height: 20),
          SizedBox(
            height: 100,
            child: ListView.separated(
              itemBuilder: (context, index) {
                return GroceriesItems(
                    groceries: groceriesitems[index % groceriesitems.length]);
              },
              separatorBuilder: (context, index) => const SizedBox(width: 10),
              itemCount: 10,
              scrollDirection: Axis.horizontal,
          ...
          SizedBox(
            ...
            child: ListView.separated(
              itemBuilder: (context, index) {
                return ProductItem(
                  product: other[index % other.length],
                );
              },
              scrollDirection: Axis.horizontal,
              itemCount: 10,
...
List<ProductItemModel> products = [
  ProductItemModel(
      image: "assets/images/Bunch-Bananas-1.jpg",
      name: "Organic Bananas",
      weight: "7pices, priceg",
      price: r"$4.99"),
  ProductItemModel(
  ...
  ProductItemModel(
      ...
      price: r"$5.99"),
  ProductItemModel(
      image: "assets/images/ginger-5108742_640.jpg",
      name: "Ginger",
      weight: "250gm, Priceg",
      price: r"$4.99"),
  ProductItemModel(
